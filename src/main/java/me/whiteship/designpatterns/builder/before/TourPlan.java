package me.whiteship.designpatterns.builder.before;
...
public class TourPlan {
    ...
    public TourPlan(String title, int nights, int days, LocalDate starteDate, String whereToStay, List<DetailPlan> plans) {
        this.title = title;
        this.nights = nights;
        this.days = days;
